...
const riddeleContainer = document.querySelector(".riddle-content");
riddeleContainer.innerHTML = " ";
...
function showMeme() {
  ...
  element.setAttribute("src",randomMemeUrl);
  clearAll();  
...
function showJoke() {
  ...
  pElement.textContent = randomJokeText;
  clearAll();
...
function showQuote() {
  ...
  QElement.textContent = randomQuote.quote;
  const QElement2 = document.createElement('p');
  QElement2.textContent = randomQuote.author;
  clearAll();
  container.appendChild(QElement);
  container.appendChild(QElement2);
}
...
function showRiddle() {
  ...
  riddle1.textContent = randomRiddle.question;
...
function revealAnswers() {
  ...
  const answer1 = document.querySelector('#riddle-answer');


  if(riddle1 && answer1.hidden){
      answer1.hidden = false;
  }
  else if(riddle1){
    alert("answer already revealed");
  }
  else if(answer1.hidden == null){
    alert("no question dispalyed to reveal answer");
  }
